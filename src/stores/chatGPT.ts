...
interface Store {
    ...
    changeCurrentTimeVideoFromAI: null | number;
}
...
const initialInnerVideoChat = () => [
    {
        id: 0,
        text: [
            "I'm NimblAI your AI assistant for knowledge discovery",
...
export const useChatGPTStore = defineStore('chatGPT', {
    state: (): Store => ({
        ...
        changeCurrentTimeVideoFromAI: null
    }),
    actions: {
        ...
        summarizeVideo() {
            this.innerVideoChat.push(
                ...
                },
                {
                    ...
                    showStatus: false,
                    text: [
                        'The video is a bankless weekly roll-up discussing the news in the crypto world. They cover topics such as the <span data="era">Arbitrum</span> airdrop, a banking crisis fallout, whether Ethereum is a security, a hack of $196 million in D5 protocol Oiler, Fidelity giving access to Bitcoin and Ether, and the fragility of D5 protocols due to their reliance on USDC stablecoin. They also mention the launch of the Bankless website, an NFT sale by Starbucks, and a crypto game pipeline by Epic. The transcript also includes various opinions and discussions related to the covered topics.',
                    ],
                    delayToResponse: 3500,
                }
            );
