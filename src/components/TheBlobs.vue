              ...
              <div class="blob">
                       <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path
                            ...
                            d="M48.6,-45.6C58.2,-39,58,-19.5,58,0C58,19.6,58.3,39.1,48.7,54.9C39.1,70.6,19.6,82.6,1.3,81.3C-17,80.1,-34.1,65.6,-47.6,49.8C-61.1,34.1,-71.2,17,-70.7,0.5C-70.3,-16.1,-59.3,-32.2,-45.8,-38.8C-32.2,-45.3,-16.1,-42.3,1.7,-44C19.5,-45.7,39,-52.1,48.6,-45.6Z"
                        >
                           <!--  <animate
                                attributeName="d"
                                dur="10000ms"
                ...
                <div class="blob">
                    <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path
                            ...
                            transform="translate(100 100)"
                            d="M49.7,-36.2C63.9,-21.7,74.7,-1.1,73.1,21C71.5,43,57.4,66.5,36.5,77.1C15.6,87.7,-12.2,85.3,-34.3,73.7C-56.5,62.1,-73.1,41.3,-78,18.2C-83,-4.9,-76.3,-30.2,-61.4,-44.9C-46.5,-59.5,-23.2,-63.4,-2.8,-61.2C17.7,-59,35.4,-50.7,49.7,-36.2Z"
                        >
                          <!--   <animate
                                attributeName="d"
                                dur="10000ms"
                ...
                <div class="absolute inset-0 backdrop-blur-3xl  bg-gradient-main-mute dark:bg-none dark:bg-black/10 z-10"></div>
          </div>
</template>
